...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CCLocation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void)receivediBeaconInfoWithProximityUUID:(NSUUID * _Nonnull)proximityUUID major:(NSInteger)major minor:(NSInteger)minor proximity:(NSInteger)proximity accuracy:(double)accuracy rssi:(NSInteger)rssi timestamp:(NSTimeInterval)timestamp;
@end
...
- (void)processIBeaconEventWithUuid:(NSUUID * _Nonnull)uuid major:(NSInteger)major minor:(NSInteger)minor rssi:(NSInteger)rssi accuracy:(double)accuracy proximity:(NSInteger)proximity timestamp:(NSTimeInterval)timestamp;
- (void)processBluetoothEventWithUuid:(NSUUID * _Nonnull)uuid rssi:(NSInteger)rssi timeInterval:(NSTimeInterval)timeInterval;
- (void)processLocationEventWithLocation:(CLLocation * _Nonnull)location;
- (void)processAliasesWithAliases:(NSDictionary<NSString *, NSString *> * _Nonnull)aliases;
- (void)processMarkerWithData:(NSString * _Nonnull)data;
